...
class FingerprintSystem:
        ...
        try:
            ...
            for fid,uid,ip,hb,un in fdb:
                 ...
                 if combined_score>highest_score: 
                     hs=combined_score; bmuid=uid; bmun=un; highest_score = hs
    ...
    def _update_verification_ui(self, match_result, error_message=None):
        if error_message:
             ...
             return
        # Adjusted threshold for enhanced algorithm (more sensitive due to better features)
        verification_threshold = 75.0  # Lowered from 80.0 due to more sophisticated matching
        if match_result:
    ...
    def extract_hog_features(self, img):
        ...
        try:
            ...
            hir = None
            if hi1 is not None: 
                hir=exposure.rescale_intensity(hi1,out_range=(0,255)).astype(np.uint8)
